...
public class oxCheckCalendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView, title, col0, col1, col2, col3, col4, col5, col6;
...
//                Toast.makeText(getApplicationContext(), month + "-"+dayOfMonth, Toast.LENGTH_LONG).show();// TODO Auto-generated method stub
